                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-10 mt-3">
                                            <h2>Hizrian</h2>
                                            <p style="width: 80%;">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, </p>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-lg-2 mt-3 ml-3">
                                            <a href="/EditProfile" class="btn btn-primary btn-round"><i class="fas fa-pen fa-sm"></i> Edit</a>
                                        </div>
                                        <div class="col-lg-3 mt-4">
                                            <a href="https://wa.me/+62812123132321"><h5><i class="fas fa-phone"></i> &nbsp;&nbsp;082121313123123</h5></a>
                                        </div>
                                        <div class="col-lg-4 mt-4">
                                            <a href="mailto:tes@gmail.com"><h5><i class="fas fa-envelope"></i> &nbsp;&nbsp;asas@gmail.com</h5></a>
                                        </div>
                                    </div>
                                    </p>
                                </div>
