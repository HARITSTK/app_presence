					...
					<div class="page-inner py-5">
						<div class="d-flex align-items-left align-items-md-center flex-column flex-md-row">
							<div>
								...
								<p class="text-white op-7 mb-2">Selamat Datang Kembali <?=session('nama')?>, Semangat selalu yaaa!!</p>
							</div>
						</div>
					</div>
				</div>
						...
						<div class="col-md-12">
							<div class="card full-height">
								<div class="card-body">
									...
									<div class="card-category">Informasi tentang semua data presensi guru di aplikasi</div>
						...
						<div class="col-md-6">
							<div class="card full-height">
								<div class="card-header">
									<div class="card-title">Feed Update Application Activity</div>
								</div>
								<div class="card-body">
