...
<body>
    <div class="wrapper">
                ...
                <div class="page-inner">
                    <div class="page-header">
                        ...
                        <ul class="breadcrumbs">
                            ...
                            <li class="nav-item">
                                <a href="/DataUserAdmin">Data User</a>
                            </li>
                        </ul>
                    </div>
                    <div class="row">
                                ...
                                <div class="card-header">
                                    <div class="d-flex align-items-left align-items-md-center flex-column flex-md-row">
                                        ...
                                        <div class="ml-md-auto py-2 py-md-0">
                                            <a href="#TambahDataLevel" data-toggle="modal" type="button" class="btn btn-primary btn-round"><i class="icon-plus"></i> Add</a>
                                        </div>
                                    </div>
                                </div>
                                <div class="card-body">
                                        ...
                                        <table id="basic-datatables" class="display table table-striped table-hover">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th style="width: 15%;">Status Verif</th>
                                                    <th style="width: 15%;">Status Active</th>
                                            ...
                                            <tbody <?= $count = 0; ?> <?php foreach ($datauser as $ds) { ?> <tr>
                                                <td><?= $count + 1; ?></td>
                                                <td><?= $ds['nama'] ?></td>
                                                <td><?= $ds['email'] ?></td>
                                                <td><?= $ds['is_verif'] ?></td>
                ...
                <footer class="footer">
                    <div class="container-fluid">
                        <div class="copyright ml-auto">
                            20124, made with <i class="fa fa-heart heart text-danger"></i> by <a href="">SANS</a>
                        </div>
                    </div>
                </footer>
            </div>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        ...
                        <a href="<?= route_to('logout') ?>" type="button" class="btn btn-danger">Logout</a>
                    </div>
                </div>
            </div>
        </div>
        ...
        <!-- Modal Tambah -->
        <div class="modal fade" id="TambahDataLevel" tabindex="-1" role="dialog" aria-labelledby="TambahJadwal" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="Tambah Jadwal">Tambah User Level</h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
                    <form action="<?= route_to('TambahUserAdmin') ?>" method="post">
                        <?= csrf_field() ?>
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="password" class="form-control" id="password" name="password" placeholder="Input Password disini ...">
                            </div>
                            <div class="row">
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        <label>Status Verif</label>
                                        <select class="form-control form-control" id="is_verif" name="is_verif" required>
                                            <option value="verif">Verificated</option>
                                            <option value="not_verif">Not Verificated</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control form-control" id="is_active" name="is_active" required>
                                            ...
                                            <option value="nonaktif">Not Activated</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="col-lg-4">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control form-control" id="NamaGuru" required>
                                <option>Verificated</option>
                                <option>Not Verificated</option>
                            </select>
                        </div>
                        <div class="form-group">
                            <label>Status Active</label>
        ...
        <div class="modal fade" id="DeleteDataLevel" tabindex="-1" role="dialog" aria-labelledby="TambahJadwal" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="Tambah Jadwal">Delete User Data</h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
