            ...
            <div class="content">
                <div class="page-inner">
                    <div class="page-header">
                        <h4 class="page-title">Level Access</h4>
                        <ul class="breadcrumbs">
                            ...
                            <li class="nav-item">
                                <a href="/LevelAccessAdmin">Level Access</a>
                            </li>
                        </ul>
                    </div>
                    <div class="row">
                            ...
                            <div class="card">
                                <div class="card-header">
                                    <div class="d-flex align-items-left align-items-md-center flex-column flex-md-row">
                                        <div>
                                            <h4 class="card-title">Level Access</h4>
                                        </div>
        ...
        <div class="modal fade" id="TambahDataLevel" tabindex="-1" role="dialog" aria-labelledby="TambahJadwal" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    ...
                    <form action="<?= route_to('CreateLevelAccess') ?>" method="post">
                        <?= csrf_field() ?>
                        <div class="modal-body">
                            <div class="form-group">
                                <label>Nama</label>
                            ...
                            <div class="form-group">
                                ...
                                <div id="level" class="form-text">Password harus memiliki 8 karakter.</div>
                            </div>
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="form-group">
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        <label>Status</label>
                                        <select class="form-control form-control" id="is_ative" name="is_active" required>
