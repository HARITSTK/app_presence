...
<head>
	...
	<link href="template/assets/doc/styles.css" rel="stylesheet" />
	<link href="template/assets/doc/prism.css" rel="stylesheet" />
</head>
								...
								<div class="dropdown-user-scroll scrollbar-outer">
									<li>
										<div class="user-box">
											...
											<div class="u-text">
												<h4>Hizrian</h4>
												<p class="text-muted">halo@gmail.com</p><a href="<?=route_to('Profile')?>" class="btn btn-xs btn-secondary btn-sm">View Profile</a>
											</div>
										</div>
									</li>
									<li>
										...
										<a class="dropdown-item" href="<?=route_to('EditProfile')?>">Edit Profile</a>
										<div class="dropdown-divider"></div>
										<a data-toggle="modal" type="button" class="dropdown-item" href="#Logout">Logout</a>
									</li>
								</div>
							</ul>
						</li>
				...
				<div class="sidebar-content">
					...
					<ul class="nav nav-primary">
						<li class="nav-item active">
							<a href="<?=route_to('DashboardUser')?>" class="collapsed" aria-expanded="false">
					...
					<div class="page-inner py-5">
						<div class="d-flex align-items-left align-items-md-center flex-column flex-md-row">
							<div>
								...
								<p class="text-white op-7 mb-2">Selamat Datang Kembali Hizrian, Semangat selalu yaaa!!</p>
							</div>
						</div>
					</div>
				</div>
						...
						<div class="col-md-12">
							<div class="card full-height">
								<div class="card-body">
									...
									<div class="card-category">Daily information about user in system</div>
									<div class="d-flex flex-wrap justify-content-around pb-2 pt-4">
										...
										<div class="px-2 pb-2 pb-md-0 text-center">
											...
											<h6 class="fw-bold mt-3 mb-0">Terlambat</h6>
										</div>
										<div class="px-2 pb-2 pb-md-0 text-center">
											<div id="circles-4"></div>
											<h6 class="fw-bold mt-3 mb-0">Tanpa Keterangan</h6>
										</div>
									</div>
								</div>
							</div>
						...
						<div class="col-md-6">
							<div class="card full-height">
								<div class="card-header">
									<div class="card-title">Feed Update Activity Aplication</div>
								</div>
								<div class="card-body">
